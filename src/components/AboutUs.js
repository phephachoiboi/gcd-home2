    ...
    <div className="w-full lg:px-0 md:px-6 sm:px-4">
      <div className="w-full">
        ...
        >
          ...
          <div className="max-w-[490px] w-full h-auto">
          ...
          <div className="flex flex-col max-w-[483px] w-full h-auto lg:mt-0 mt-8 lg:px-0 md:px-6 px-4 lg:items-start items-center lg:text-left text-center">
            <div className="max-w-[73px] w-full font-poppins font-semibold text-[16px] leading-[20px] text-[#FF64AE]">
              <p className="m-0">About Us</p>
            </div>
            <div
              className="max-w-[460px] w-full font-poppins font-semibold lg:text-[36px] text-[28px] mt-[12px]
             lg:leading-[45px] leading-[38px] text-[#091156] "
            >
              <p className="m-0"> We are the best beauty clinic</p>
            </div>
            <div className="max-w-[483px] w-full font-poppins font-normal text-[16px] leading-[24px] text-[#8B8B8B] tracking-[0.1em] mt-[10px]">
              <p className="m-0">
            ...
            <button
              className="inline-block relative max-w-[200px] lg:w-full h-auto lg:mt-[45px] mt-[20px]
