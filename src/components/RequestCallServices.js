  ...
  return (
    <div className="w-full lg:px-0 md:px-6 sm:px-4">
      <div className="w-full">
        <div className="flex lg:flex-row flex-col max-w-[1139px] w-full h-auto mt-[169px] lg:px-0 md:px-6 sm:px-4 mx-auto lg:justify-between">
          {/* Left side title */}
          <div className="flex flex-col lg:items-start lg:text-start items-center text-center">
            <div className="w-[391px] h-[50px] font-poppins font-semibold text-[36px] leading-[45px] text-[#091156]">
              <p className="m-0">Request call services</p>
            </div>
            <div className="w-[391px] h-[60px] mt-[12px] font-poppins font-normal text-[16px] leading-[24px] tracking-[0.1em] text-[#8B8B8B]">
              <p className="m-0">
          ...
          <div className="flex flex-col mt-[13px] lg:text-end text-center lg:mx-0 mx-auto">
            <div className="flex md:flex-row flex-col h-auto max-w-[658px] w-full mx-auto items-center">
              <div className="h-auto sm:w-[545px] w-[290px]">
                <form>
                  <input
                    className="md:pl-[37px] px-4 border-[1px] w-full rounded-[25px] md:rounded-[25px_0px_0px_25px]"
                    type="text"
                    id="phone"
                    name="phone"
            ...
            <div
              className="max-w-[658px] w-full lg:h-[17px] h-auto mt-[8px] font-poppins font-normal italic text-[12px] leading-[18px]
